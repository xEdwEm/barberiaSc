            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <p>
                            Somos la mejor barberia del Mundo, te sentiras como en casa!!
                            <br>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h3>Tenemos servicios completos</h3>
                        <p>
                            Con los mejores tratamientos para el pelo !!
                            <br>
                            y recomendaciones para su cuidado.
                        </p>
                    </div>
                </div>
                <!-- THIRD SLIDE -->
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h3>Con un menu super variado</h3>
                        <p>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about_content" style="text-align: center;">
                    ...
                    <p style="color: #777">
                        Somos una peluquería enfocada en nuestros clientes, antes de empezar analizamos tu tipo de pelo para recomendarte tu mejor corte.
                        Como siempre respetando como máxima tu criterio, tus gustos y preferencias ante todo.
                    </p>
                    <a href="#" class="default_btn" style="opacity: 1;">Más acerca de nosotros</a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 padd_col_res">
                <div class="service_box">
                    ...
                    <p>Los mejores cortes de cabellos adaptados a la forma de tu cara</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 padd_col_res">
                <div class="service_box">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <p>
                            Con los mejores tratamientos para la cara !!
                            <br>
                            con ligeros masajes.
                        </p>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="Design/images/barbershop_image_1.jpg" alt="First slide" style="visibility: hidden;">
                    <div class="carousel-caption d-md-block">
                        <h3>Te ofrecemos recomendaciones</h3>
                        <p>
                            Te damos recomendaciones para el cuidado de tu pelo !!
                            <br>
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="Design/images/barbershop_image_1.jpg" alt="First slide" style="visibility: hidden;">
                    <div class="carousel-caption d-md-block">
                        <h3>Una experiencia para volver</h3>
                        <p>
                            Tratamos como familia a nuestros clientes !!
                            <br>
                            Y mantemenos un vinculo con nuestro cliente.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 sm-padding">
                <div class="contact-info">
                    ...
                    <h3>
                        Calle Club de los leones
                        <br>
                        Alma rosa 1era
                    </h3>
                    <h4>
                        <span style="font-weight: bold">Email:</span>
                        scarletBarberia@gmail.com
                        <br>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    ...
                    <p>
                        Somos tu mejor opción, estamos para tu comodidad y satisfacción.
                    </p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    <h3>Dirección</h3>
                    <p>
                        Calle Club de los leones alama rosa 1era #23
                    </p>
                    <p>
                        scarletbarberia@gmail.com
                        <br>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class="opening_time">
                        <li>Lunes - Sabados 9:30am - 10:00 pm</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
